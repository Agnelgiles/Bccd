...
parser.add_argument("-o", "--parser", dest="parser", help="Parser to use. One of simple or pascal_voc",
                    default="pascal_voc")
parser.add_argument("--img_size", dest="img_size", help="image size to reshape", type=int, default=600)
parser.add_argument("-n", "--num_rois", type=int, dest="num_rois", help="Number of RoIs to process at once.",
                    default=32)
parser.add_argument("--network", dest="network", help="Base network to use. Supports vgg or resnet50.",
                    default='vgg')
parser.add_argument("--hf", dest="horizontal_flips", help="Augment with horizontal flips in training. (Default=false).",
                    action="store_true", default=False)
parser.add_argument("--vf", dest="vertical_flips", help="Augment with vertical flips in training. (Default=false).",
                    action="store_true", default=False)
parser.add_argument("--rot", "--rot_90", dest="rot_90",
...
parser.add_argument("--config_filename", dest="config_filename", help="Location to store all the metadata related to "
                                                                      "the training (to be used when testing).",
                    default="config.pickle")
parser.add_argument("--output_weight_path", dest="output_weight_path", help="Output path for weights.",
                    default='./model_frcnn.hdf5')
parser.add_argument("--input_weight_path", dest="input_weight_path",
                    help="Input path for weights. If not specified, will try to load default weights provided by keras.")

args = parser.parse_args()

if not args.train_path:  # if filename is not given
...
if args.img_size == 300:
    C.im_size = args.img_size
